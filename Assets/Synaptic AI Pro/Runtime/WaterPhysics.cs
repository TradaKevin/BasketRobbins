...
namespace Synaptic
{
    ...
    public class Buoyancy : MonoBehaviour
    {
        ...
        void FixedUpdate()
        {
            ...
            if (isUnderwater)
            {
                ...
                rb.drag = Mathf.Lerp(originalDrag, underwaterDrag, submergedRatio);
                rb.angularDrag = Mathf.Lerp(originalAngularDrag, underwaterAngularDrag, submergedRatio);
            }
            else
            {
                rb.drag = originalDrag;
            ...
            {
                if (rb.velocity.magnitude > splashThreshold)
                {
                    CreateSplash();
                }
            }
    ...
    public class WaterInteraction : MonoBehaviour
    {
        ...
        void OnTriggerEnter(Collider other)
        {
            ...
            if (rb != null && rb.velocity.magnitude > minSplashVelocity)
            {
                CreateSplashAt(other.ClosestPoint(transform.position), rb.velocity.magnitude);
            }
        }
